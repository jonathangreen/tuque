...
class DatastreamTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->testDsidR = TestHelpers::randomCharString(10);
    ...
    public function testLabel()
    {
        ...
        $this->ds->label = TestHelpers::randomString(355);
...
foo;
   ...
   *
   * @expectedException \Islandora\Tuque\Exception\RepositoryException
