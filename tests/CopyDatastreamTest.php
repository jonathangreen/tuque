...
class CopyDatastreamTest extends PHPUnit_Framework_TestCase
{
    ...
    protected $testPid;
    protected $testPid2;
    protected $new_object;
    protected $testDsid;
    protected $testDsContents;
    protected $object;
    protected $ds;
    protected $tempfile1;
    protected $tempfile2;
    ...
    protected function setUp()
    {
        ...
        $string4 = TestHelpers::randomString(10);
   ...
   */
    ...
    {
        $this->assertTrue(
            $this->new_object->ingestDatastream($this->object[$this->testDsid]),
            'Create datastream entry on new object'
        );
        $object = $this->repository->ingestObject($this->new_object);
   ...
   */
    public function testCopiedIngest()
    {
        ...
        $this->assertTrue(
            $datastream instanceof NewFedoraDatastream,
            'Datastream was copied into a NewFedoraDatastream.'
        );
